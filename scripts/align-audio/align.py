...
Usage (see README.md):
    python3 align.py [model]        # model: small (default) | medium | large-v3
"""
...
OUT   = os.path.join(HERE, "..", "..", "src", "data", "editoTimingsA2.js")
...
def emit(result, model_name):
    ...
    with open(OUT, "w") as f:
        f.write("\n".join(lines))
    print("→ src/data/editoTimingsA2.js")
