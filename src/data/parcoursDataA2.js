...
export const PARCOURS_UNITS_A2 = [
  { id:"b1", num:1, fr:"Nouvelles vies", vi:"Cuộc sống mới", grammar:"Passé composé · Négation · il y a/pendant/depuis", emoji:"🌱",
    intro:"Kể lại những thay đổi lớn trong cuộc sống với passé composé, phủ định và các mốc thời gian (il y a, pendant, depuis)." },
  { id:"b2", num:2, fr:"Je me souviens", vi:"Tôi nhớ lại", grammar:"L'imparfait · Pronoms y/en · Place de l'adjectif", emoji:"📷",
    intro:"Hồi tưởng kỷ niệm quá khứ với thì imparfait, đại từ y/en và cách đặt vị trí tính từ." },
  { id:"b3", num:3, fr:"Comme à la maison", vi:"Như ở nhà", grammar:"Pronoms relatifs qui/que/où · Comparaison · Si + présent", emoji:"🏠",
    intro:"Miêu tả nơi ở và cuộc sống thường nhật bằng đại từ quan hệ (qui/que/où), so sánh và câu điều kiện với si." },
  { id:"b4", num:4, fr:"Tous pareils, tous différents", vi:"Ai cũng giống, ai cũng khác", grammar:"Comparaison : équivalence · Adjectifs indéfinis · Pronoms possessifs", emoji:"🎭",
    intro:"So sánh sự giống và khác nhau giữa mọi người bằng cấu trúc so sánh ngang bằng, tính từ bất định và đại từ sở hữu." },
  { id:"b5", num:5, fr:"En route vers le futur !", vi:"Trên đường đến tương lai!", grammar:"Futur simple · Si/Quand + futur · Le pronom on", emoji:"🚀",
    intro:"Nói về dự định và tương lai với thì futur simple, cấu trúc si/quand + futur và đại từ on." },
  { id:"b6", num:6, fr:"En cuisine", vi:"Vào bếp", grammar:"Le pronom en · L'obligation et l'interdiction · La restriction ne… que", emoji:"🍳",
    intro:"Nói về nấu ăn, công thức món ăn với đại từ en, cách diễn đạt bắt buộc/cấm đoán và giới hạn ne… que." },
  { id:"b7", num:7, fr:"À votre santé !", vi:"Chúc sức khỏe!", grammar:"Les pronoms COD et COI · Le superlatif · Les pronoms interrogatifs (lequel…)", emoji:"💊",
    intro:"Bàn về sức khỏe và thể thao bằng đại từ bổ ngữ trực tiếp/gián tiếp, so sánh nhất và đại từ nghi vấn lequel." },
  { id:"b8", num:8, fr:"Dans les médias", vi:"Trong thế giới truyền thông", grammar:"La cause et la conséquence · Le subjonctif présent · La place des pronoms COD et COI", emoji:"📰",
    intro:"Bàn luận về tin tức và truyền thông với cách diễn đạt nguyên nhân – kết quả, thức subjonctif và vị trí đại từ bổ ngữ." },
  { id:"b9", num:9, fr:"Consommer responsable", vi:"Tiêu dùng có trách nhiệm", grammar:"Le conditionnel présent (1) · Le gérondif · Le conditionnel présent (2)", emoji:"🔄",
    intro:"Bày tỏ mong muốn và đề xuất tiêu dùng bền vững với thì điều kiện (conditionnel) và gérondif." },
  { id:"b10", num:10, fr:"Envies d'ailleurs ?", vi:"Nỗi thèm đi đây đi đó?", grammar:"Le passé composé et l'imparfait dans le récit · L'accord du participe passé · Les pronoms démonstratifs", emoji:"✈️",
    intro:"Kể chuyện du lịch mạch lạc bằng cách phối hợp passé composé và imparfait, cùng quy tắc hòa hợp quá khứ phân từ." },
  { id:"b11", num:11, fr:"De jolis parcours", vi:"Những hành trình đẹp", grammar:"La mise en relief · Le discours rapporté au présent · Le pronom COI y", emoji:"🎓",
    intro:"Kể lại hành trình học tập, sự nghiệp — nhấn mạnh thông tin và thuật lại lời nói của người khác." },
  { id:"b12", num:12, fr:"Soif de nature", vi:"Khát khao thiên nhiên", grammar:"L'impératif et les pronoms · L'expression du but · La forme passive", emoji:"🌳",
    intro:"Bàn về thiên nhiên và môi trường, dùng thức mệnh lệnh kết hợp đại từ, diễn đạt mục đích và thể bị động." },
];
  ...
  },
  {
    ...
    steps: [
      ...
      { id:"c2_lecture2", stepKey:"lecture", subIds:["b10-livre-ca-vous-a-plu"],
        ...
        section:"lecture", view:"lecture" },
      { id:"c2_grammar1", stepKey:"grammar", subIds:["p1"],
        icon:"⚜️", kind:"Ngữ pháp", color:"#1B3A6B", sub:"L'accord du participe passé",
        section:"grammar", view:"grammar" },
      { id:"c2_grammar2", stepKey:"grammar", subIds:["p2"],
