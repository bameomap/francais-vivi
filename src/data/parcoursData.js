...
export const PARCOURS_UNITS = [
  { id:"u0",  num:0,  fr:"Bienvenue !",               vi:"Khởi động",           grammar:"Salutations · Alphabet",           emoji:"👋",
    intro:"Làm quen với tiếng Pháp: chào hỏi, bảng chữ cái, đếm số và các đồ vật trong lớp học." },
  { id:"u1",  num:1,  fr:"Je suis…",                  vi:"Tôi là…",             grammar:"Être · avoir · articles",          emoji:"🪪",
    intro:"Tự giới thiệu bản thân — tên, quốc tịch, nghề nghiệp — với động từ être, avoir và mạo từ cơ bản." },
  { id:"u2",  num:2,  fr:"Près de moi",               vi:"Xung quanh tôi",      grammar:"Adjectifs · pluriel",              emoji:"🏘️",
    intro:"Nói về gia đình và những người, đồ vật xung quanh bạn bằng tính từ mô tả và số nhiều." },
  { id:"u3",  num:3,  fr:"Qu'est-ce qu'on mange ?",   vi:"Chúng ta ăn gì?",    grammar:"Articles partitifs · quantité",    emoji:"🥐",
    intro:"Gọi món, nói về thói quen ăn uống và số lượng thực phẩm với mạo từ bộ phận (du, de la…)." },
  { id:"u4",  num:4,  fr:"C'est où ?",                vi:"Ở đâu?",              grammar:"Prépositions · questions",         emoji:"🗺️",
    intro:"Hỏi đường và chỉ vị trí trong thành phố bằng giới từ chỉ nơi chốn và các dạng câu hỏi." },
  { id:"u5",  num:5,  fr:"C'est tendance !",          vi:"Thời trang!",         grammar:"Adjectifs couleurs · comparatif",  emoji:"👗",
    intro:"Miêu tả trang phục, màu sắc và so sánh giữa hai sự vật, hai người." },
  { id:"u6",  num:6,  fr:"Qu'est-ce qu'on fait ?",    vi:"Làm gì hôm nay?",    grammar:"Verbes réguliers · futur proche",  emoji:"📅",
    intro:"Nói về hoạt động hàng ngày và lên kế hoạch cho tương lai gần với thì futur proche." },
  { id:"u7",  num:7,  fr:"Chez moi !",                vi:"Nhà tôi!",            grammar:"Prépositions lieu · il y a",       emoji:"🏠",
    intro:"Mô tả nhà ở và đồ đạc trong nhà bằng il y a và các giới từ chỉ vị trí." },
  { id:"u8",  num:8,  fr:"En forme !",                vi:"Sức khỏe!",           grammar:"Impératif · verbes pronominaux",   emoji:"💪",
    intro:"Nói về sức khỏe, thể thao và đưa lời khuyên bằng thức mệnh lệnh (impératif) và động từ phản thân." },
  { id:"u9",  num:9,  fr:"Bonnes vacances !",         vi:"Kỳ nghỉ vui!",        grammar:"Passé composé · avoir/être",       emoji:"🌴",
    intro:"Kể lại một kỳ nghỉ đã qua — đặt phòng, di chuyển, kể chuyện — với thì passé composé (avoir/être)." },
  { id:"u10", num:10, fr:"Au travail !",              vi:"Đi làm!",             grammar:"Passé composé · futur proche (révision)", emoji:"💼",
    intro:"Nói về công việc, ngành học, đồng thời ôn tập passé composé và futur proche đã học." },
];
